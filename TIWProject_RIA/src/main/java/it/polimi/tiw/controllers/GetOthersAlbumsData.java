...
/**
 * Servlet implementation class GetOthersAlbumsData
 */
@WebServlet("/GetOthersAlbumsData")
@MultipartConfig
public class GetOthersAlbumsData extends HttpServlet {
